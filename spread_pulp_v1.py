...
# Attempt at implementing an ILP Solver 10/11
# Maximizes TOTAL spread
...
# Define the problem
prob = pulp.LpProblem("Maximize_Total_Spread", pulp.LpMaximize)
...
# Objective function
prob += pulp.lpSum([spread * x[(week, team)] for week in possible_picks for team, spread in possible_picks[week]])
